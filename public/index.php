...
<body>
    ...
    <div class="content-wrapper">
      ...
      <div class="progress-section">
        <div class="progress-info">
          ...
          <span id="progress-text" class="badge badge-progress">0 de 0 completadas</span>
        </div>
        <div class="progress">
      ...
      <form id="audit-form" action="#" method="POST">
        <div class="company-section">
          ...
          <input type="text" class="form-control company-input" id="company-input" placeholder="Ingresa el nombre de la empresa" required>
        </div>
  ...
  <script src="/proyecto/assets/js/audit.js"></script>
</body>
